  ...
  return (
    <div className="h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 h-screen flex flex-col">
        {/* Navigation */}
        <nav className="w-full px-6 sm:px-8 py-4 sm:py-6">
        ...
        <div className="flex-1 flex items-center justify-center px-6 sm:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fade-in">
              ...
              {/* Main Headline */}
              <h1 className="text-4xl sm:text-7xl md:text-8xl lg:text-9xl font-light text-gray-900 mb-6 sm:mb-12 tracking-tight leading-none">
                GPA
                <span className="block text-blue-600 font-normal">Calculator</span>
              </h1>
              
              {/* Subtitle */}
              <p className="text-lg sm:text-2xl md:text-3xl text-gray-600 mb-12 sm:mb-20 max-w-3xl mx-auto font-light leading-relaxed">
              ...
              <div className="space-y-4 sm:space-y-6">
                <Button 
                  ...
                  size="lg"
                  className="bg-black hover:bg-gray-800 text-white px-10 sm:px-16 py-5 sm:py-8 text-lg sm:text-xl font-medium rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-0 w-full sm:w-auto min-h-[56px] sm:min-h-[64px] touch-manipulation"
                >
                  Get Started
      ...
      <footer className="absolute bottom-0 w-full text-center py-3 sm:py-4 text-sm text-gray-500 z-20">
